...
import FieldCultivationService from "../field-cultivation/FieldCultivationService";
...
export const useFieldCultivations = () => {
  const [fieldCultivations, setFieldCultivations] = useState<FieldCultivationData[]>([]);
